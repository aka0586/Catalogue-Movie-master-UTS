...
public class DetailActivity extends AppCompatActivity {
    ...
    private void storeData() {
        ...
        Glide.with(this)
                .load("https://image.tmdb.org/t/p/w500/8uO0gUM8aNqYLs1OsTBQiXu0fEv.jpg" + item.getBackdropPath())
                .into(iv_backdrop);

        Glide.with(this)
                .load("https://image.tmdb.org/t/p/w500/8uO0gUM8aNqYLs1OsTBQiXu0fEv.jpg" + item.getPosterPath())
                .into(iv_poster);
